...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ 'bh279_frontend/css/materialize.min.css' }}"  media="screen,projection"/>
    <!-- Latest compiled and minified CSS & JS -->
    <link rel="stylesheet" href="{{ 'bh279_frontend/css/normalize.css' }}">
     <link rel="stylesheet" href="{{ 'bh279_frontend/css/swiper.min.css' }}">

    <link rel="stylesheet" href="{{ 'bh279_frontend/css/style.css' }}">

    <script src="{{ 'bh279_frontend/js/jquery.min.js' }}"></script>
    <script type="text/javascript" src="{{ 'bh279_frontend/js/materialize.min.js' }}"></script>
    <script src="{{ 'bh279_frontend/js/swiper.jquery.min.js' }}"></script>
    <script src="{{ 'bh279_frontend/js/myscript.js' }}"></script>
<style>
</style>
</head>
<body >
